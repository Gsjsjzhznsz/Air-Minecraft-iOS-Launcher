...
- (void)setupErrorCard {
    ...
    _errorCardView.layer.cornerRadius = 16;  // Task137：回归原生卡片圆角
...
- (void)setupSuggestionsCard {
    ...
    _suggestionsCardView.layer.cornerRadius = 16;  // Task137：回归原生卡片圆角
...
- (void)setupLogCard {
    ...
    _logCardView.layer.cornerRadius = 16;  // Task137：回归原生卡片圆角
