...
int loaded = 0;
// Task173 (iOS port): the bundled ANGLE-backed frameworks live in the app
// bundle Frameworks/ dir; dlopen must go through @rpath (the vgpu dylib and
// the executable both carry -rpath @executable_path/Frameworks). A bare
// "libGLESv2.framework/libGLESv2" leaf name would only search the system
// framework fallback dirs and fail.
