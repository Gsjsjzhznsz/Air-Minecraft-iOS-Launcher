...
// Task173 (iOS port): clang 15+ errors on implicit function declarations
// (the Android NDK build let the bare glStencilFunc call slide as a warning).
// Forward-declare the gl4es implementation and route the recursion through it.
void gl4es_glStencilFunc(GLenum func, GLint ref, GLuint mask);
void gl4es_glStencilOp(GLenum sfail, GLenum zfail, GLenum zpass);
