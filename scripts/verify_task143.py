...
print("== F. No l10n baseline drift (keys stay at 1946 x4) ==")
total = None
drift = []
...
check(f"F1 four-language key sets identical at {total} keys (Task150 baseline 1946)",
      total == 1946 and not drift, f"drift={drift}")
