...
print("== F. No l10n baseline drift (keys stay at 1948 x4) ==")
total = None
drift = []
...
check(f"F1 four-language key sets identical at {total} keys (Task157 baseline 1948)",
      total == 1948 and not drift, f"drift={drift}")
