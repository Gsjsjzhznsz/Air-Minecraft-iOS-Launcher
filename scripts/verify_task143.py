...
print("== F. No l10n baseline drift (keys stay at 1945 x4) ==")
total = None
drift = []
...
check(f"F1 four-language key sets identical at {total} keys (Task150 baseline 1945)",
      total == 1945 and not drift, f"drift={drift}")
