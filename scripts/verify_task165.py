...
# 置顶区口径放宽为前三位（同惯例）。
check("G1 task165 公告置顶区（前三位；Task166/167 后续 prepend）且内容含根因与装机锚点",
      t165 is not None and any(anns[i]["id"] == "task165-blackscreen-rootcause-2026-09-25" for i in range(min(3, len(anns))))
