...
check("G1 task165 公告置顶区（Task177 重锚：同日组前十五位；server-pin + Task177/169/175/174/双173/172/171/170/168 prepend 后）且内容含根因与装机锚点",
      t165 is not None and any(anns[i]["id"] == "task165-blackscreen-rootcause-2026-09-25" for i in range(min(15, len(anns))))
