...
check("G1 task165 公告置顶区（2026-09-25 同日组前八位；server-pin + Task169/168/170 prepend 后）且内容含根因与装机锚点",
      t165 is not None and any(anns[i]["id"] == "task165-blackscreen-rootcause-2026-09-25" for i in range(min(8, len(anns))))
