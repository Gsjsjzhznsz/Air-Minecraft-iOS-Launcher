...
check("E1 task167 公告置顶（Task175 重锚：task175/174 + 十症状 task173 相继 prepend 后居同日组第 12；双根因 + 装机验证清单）",
      len(a167) == 1
      and any(anns[i]["id"] == "task167-crashfix-migration-2026-09-25" for i in range(min(12, len(anns))))
