...
check("E1 task167 公告置顶（Task171 重锚：task171 prepend 后居同日组第 7；双根因 + 装机验证清单）",
      len(a167) == 1
      and any(anns[i]["id"] == "task167-crashfix-migration-2026-09-25" for i in range(min(7, len(anns))))
