...
check("E1 task167 公告置顶（Task178 重锚：task178/177/175/174 + 十症状 task173 相继 prepend 后居同日组第 14；双根因 + 装机验证清单）",
      len(a167) == 1
      and any(anns[i]["id"] == "task167-crashfix-migration-2026-09-25" for i in range(min(15, len(anns))))
