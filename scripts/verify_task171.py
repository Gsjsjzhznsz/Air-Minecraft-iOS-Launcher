...
check("D2 公告（Task177 重锚）：task171 在 index 8（task177/175/174/双 task173/172 相继插入后）；置顶服务器推荐仍在 anns[0]；task169 仍在 anns[1]",
      anns[8]["id"] == "task171-seven-fixes-2026-09-25"
...
check("D3 task171 公告内容七条全列",
      all(k in anns[8]["content"] for k in ["①", "②", "③", "④", "⑤", "⑥", "⑦"]))
wl = rd("worklog.md")
