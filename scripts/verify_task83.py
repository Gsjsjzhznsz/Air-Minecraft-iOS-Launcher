...
check("B12 FAQ：27 条目（Task83 19 + Task83b +3 + Task84 +1 Arm ASR + Task85 +1 替代方案调研 + Task86 +1 大型整合包首启卡死 + Task87 +1 LTW×26.x + Task94 +1 Sodium LWJGL 版本门）",
      len(faq_items) == 27, f"got {len(faq_items)}")
