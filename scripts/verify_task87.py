...
check("E1 32 条目（Task99 +2 macMenuStub/fsrCorner；Task87 +ltw26，Task94 +sodiumLwjgl，Task95 +missingMods，Task97 +cwdMismatch，Task98 +mc26sdl）", len(faq_items) == 32, f"got {len(faq_items)}")
